...
public class FileController extends BaseController {
    ...
    public FileController(Pipeline pipeline, AuthenticationManager authenticationManager,
    ...
    public ResponseEntity<Collection<PageStatistic>> getSingleViewerStatistic(@PathVariable Long viewerId,
    ...
    public ResponseEntity<?> getPageThumbnail(@PathVariable Long id, @PathVariable int pageNumber,
