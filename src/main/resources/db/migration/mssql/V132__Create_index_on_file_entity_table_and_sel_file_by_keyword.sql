CREATE NONCLUSTERED INDEX IX_FILE_ENTITY_COMPANY_ID_DISPLAY_NAME ON file_entity(company_id,display_name)
GO

GO CREATE  PROCEDURE [dbo].[sel_file_by_keyword]
    @keyword VARCHAR (255),
...
BEGIN
    ...
    DECLARE @totalRows INT = (SELECT COUNT(*) AS COUNT FROM @AllFileId)
